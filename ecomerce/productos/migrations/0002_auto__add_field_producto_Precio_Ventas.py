...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Producto.Precio_Ventas'
        db.add_column(u'productos_producto', 'Precio_Ventas',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=100, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Producto.Precio_Ventas'
        db.delete_column(u'productos_producto', 'Precio_Ventas')
